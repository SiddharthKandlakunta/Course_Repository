...
my_details(fname = 'John', lname = 'Doe', age = 30, occupation = 'Doctor')
...
user_details('Johndoe', age = 40, occupation = 'Lawyer')
...
func('user info', 'johndoe','janedoe', age = 30, city = 'New york')
...
example_2(**person) #same as: example_2(fname = 'John', lname = 'Doe')