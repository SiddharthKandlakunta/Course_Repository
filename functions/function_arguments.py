...
my_name('Johndoe') #'Johndoe' is the argument
...
key_word(color = 'red', name = 'Johndoe')
key_word('Sid', 'White')#positional arguments, order matters here
key_word('Siddharth', color = 'blue') #you can also mix kwargs and positional arguments
